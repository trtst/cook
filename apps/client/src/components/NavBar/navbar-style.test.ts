...
expectIncludes("backgroundColor?: string;");
expectIncludes("backgroundColor: undefined");
expectIncludes("foregroundColor?: string;");
expectIncludes("foregroundColor: undefined");
...
expectIncludes("...(props.backgroundColor ? { backgroundColor: props.backgroundColor } : {})");
expectIncludes("...(props.foregroundColor ? { \"--navbar-foreground-color\": props.foregroundColor } : {})");
...
expectSelectorIncludes(".navbar__title", ["color: var(--navbar-foreground-color, var(--color-text));"]);
expectSelectorIncludes(".navbar__icon", ["color: var(--navbar-foreground-color, var(--color-text));"]);
