...
assert.equal(oneColorVars["--notification-badge-text"], "#ffffff");
...
assert.equal(twoColorVars["--notification-badge-text"], "#ffffff");
...
assert.equal(darkVars["--notification-badge-text"], "#ffffff");
