...
const homePageSource = readFile("./index.vue");

expectSelectorIncludes(homePageSource, ".feature-card__weekmark-icon", [
  "color: var(--color-text);"
]);
expectSelectorExcludes(homePageSource, ".feature-card__weekmark-icon", [
  "color: var(--color-icon-accent);"
]);

console.log("home weekmark style tests passed");
