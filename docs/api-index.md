...
| AdminHomeTopic | DELETE | `/admin/home-topics/{topicId}` | 后台删除未上架本周灵感专题 |
...
| AdminTableTopic | DELETE | `/admin/table-topics/{topicId}` | 后台删除未上架餐桌话题 |
...
| AdminIngredient | POST | `/admin/ingredient-categories/{categoryId}/status` | 后台上架或下架系统食材分类 |
| AdminIngredient | DELETE | `/admin/ingredient-categories/{categoryId}` | 后台删除未被引用的系统食材分类 |
...
| AdminIngredient | DELETE | `/admin/pending-units/{recommendationId}` | 后台删除待审核单位建议 |
